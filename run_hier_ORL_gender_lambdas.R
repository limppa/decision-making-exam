...
params <- c("mu_a_rew", "alpha_a_rew", "lambda_a_rew",
            "mu_a_pun", "alpha_a_pun", "lambda_a_pun",
            "mu_omega_f", "alpha_omega_f", "lambda_omega_f",
            "mu_K", "lambda_K",
            "mu_omega_p", "lambda_omega_p")
...
# Save results
save(fit, file = "results/ORL_gender_lambdas_results.RData")